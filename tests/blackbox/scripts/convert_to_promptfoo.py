...
def convert_expectation_to_assertions(
    ...
    if keywords and len(keywords) >= MIN_KEYWORDS_FOR_ASSERTION:
        assertions.append(
            {
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Convert scenario.yml files to Promptfoo format"
    )
    parser.add_argument(
        "--scenarios-dir",
        type=Path,
    ...
    print("  3. Refine expectations as needed")

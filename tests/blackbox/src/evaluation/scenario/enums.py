...
class TestStatus(StrEnum):
    ...
    COMPLETED = "completed"  # COMPLETED means that the test is completed but with score < 100%.
    FAILED = "failed"  # FAILED means that the test failed to get response from companion.

...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            b'{"event": "agent_action", "data": {"agent": "Supervisor", "answer": {"messages": [{"content": "{\\n  \\"next\\": \\"KymaAgent\\"\\n}"}], "next": "KymaAgent", "subtasks": [{"description": "Create a Hello World Python Serverless Function in Kyma.", "assigned_to": "KymaAgent", "status": "pending", "result": null}, {"description": "Create an API Rule to expose the Python Serverless Function externally.", "assigned_to": "KymaAgent", "status": "pending", "result": null}]}}}',
        ),
        (
            b'{"KymaAgent": {"messages": [{"content": "To create an API Rule in Kyma to expose a service externally", "additional_kwargs": {}, "response_metadata": {}, "type": "ai", "name": "Supervisor", "id": null, "example": false, "tool_calls": [], "invalid_tool_calls": [], "usage_metadata": null}]}}',
        ...
        (
            b'{"KubernetesAgent": {"messages": [{"content": "To create a kubernetes deployment", "additional_kwargs": {}, "response_metadata": {}, "type": "ai", "name": "Supervisor", "id": null, "example": false, "tool_calls": [], "invalid_tool_calls": [], "usage_metadata": null}]}}',

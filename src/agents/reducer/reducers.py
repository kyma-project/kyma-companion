...
from agents.reducer.utils import compute_messages_token_count, filter_messages_by_token_limit, summarize_messages
from utils.models.factory import ModelType


def summarize_and_add_messages_token(token_lower_limit, token_upper_limit,
                                     summarization_model_type: ModelType, tokenizer_model_type: ModelType):
    ...
    def callback(left: Messages, right: Messages) -> Messages:
        ...
        token_count = compute_messages_token_count(combined_messages, tokenizer_model_type)
        ...
        summarized_message = summarize_messages(msgs_to_be_summarized, summarization_model_type)

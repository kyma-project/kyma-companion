...
## .env file structure
# AICORE_CONFIGURATION_ID=<AICORE_CONFIGURATION_ID>
# AICORE_DEPLOYMENT_ID=<AICORE_DEPLOYMENT_ID>
# AICORE_RESOURCE_GROUP=<AICORE_RESOURCE_GROUP>
# AICORE_LLM_CLIENT_ID=<AICORE_LLM_CLIENT_ID>
# AICORE_LLM_CLIENT_SECRET=<AICORE_LLM_CLIENT_SECRET>
# AICORE_LLM_AUTH_URL=<AICORE_LLM_AUTH_URL. https://*******.authentication.sap.hana.ondemand.com>
# AICORE_SERVICE_URLS='{"AI_API_URL":"https://*******.ml.hana.ondemand.com"}'
